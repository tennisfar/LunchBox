...
brows_sync() {
  ...
  ds
  browser-sync start --proxy 'https://web.develop.danskespil.dk' --files './Website/BuildArtifacts/Components/DanskeSpil/**/*.css' './Website/BuildArtifacts/Components/DanskeSpil/**/*.js' --no-notify --host 'web.develop.danskespil.dk' --open external --no-ghost-mode --no-ui
}
alias bs='brows_sync'
